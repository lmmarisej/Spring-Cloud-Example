...
public class InstanceInfo {
    ...
    public enum ActionType {
        ADDED, // Added in the discovery server     添加Eureka Server
        MODIFIED, // Changed in the discovery server        在 Euerka Server 中的信息发生改变
        DELETED
        // Deleted from the discovery server        被从 Eureka Server 中剔除
    }
