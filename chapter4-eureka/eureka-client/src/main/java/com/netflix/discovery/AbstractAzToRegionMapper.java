 ...
 * @author Nitesh Kant
 */
public abstract class AbstractAzToRegionMapper implements com.netflix.discovery.AzToRegionMapper {

    private static final Logger logger = LoggerFactory.getLogger(com.netflix.discovery.InstanceRegionChecker.class);
    ...
    protected AbstractAzToRegionMapper(com.netflix.discovery.EurekaClientConfig clientConfig) {
