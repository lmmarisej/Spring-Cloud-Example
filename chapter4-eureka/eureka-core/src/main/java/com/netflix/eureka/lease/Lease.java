 ...
 *
 *  代表一个 Eureka Client服务实例信息的租约，它提供了对其内持有的类的时间有效性操作。
 *
 *  Lease持有的类是代表服务实例信息的 Instanceinfo。
 *
 *  Lease 中定义了租约的操作类型，分别是注册、下线、更新，同时提供了对租约中时间属性的各项操作。
 *  租约默认有效时长( duration)为 90 秒。
 */
