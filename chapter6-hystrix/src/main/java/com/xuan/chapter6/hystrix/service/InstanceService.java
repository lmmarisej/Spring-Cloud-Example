...
public class InstanceService {
    ...
    // HystrixCommand注解来包装需要保护的远程调用方法
    // @HystrixCommand 注解将该方法纳入到 Hystrix 的监控中。
    @HystrixCommand(fallbackMethod = "instanceInfoGetFail",     // 指定回滚的方法 instancelnfoGetFail
    ...
    public Instance getInstanceByServiceIdWithRestTemplate(String serviceId) {
        return restTemplate.getForEntity("http://feign-service/instance/{serviceId}", Instance.class, serviceId).getBody();
    }
